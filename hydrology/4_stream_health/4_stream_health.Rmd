...
Also we will do this assessment twice. Once at Young's Gulch and once on a stream effected by the recent Cameron Peak fire. You will then compare the health of both streams as evaluated below. 
...
Use the data you collected in the field work section to answer the following questions for both streams (Young's Gulch and Cameron Peak fire stream)
...
a. Include a copy of your field sketches (5 pts)
    
b. Generate the table below with the following information. Interpretation refers to excellent, good, poor, etc health (5 pts)

![](images/table_1.jpg)
    
c. How do your 2 stream health assessments, biotic and physical, compare to one another within each stream? What might account for any differences? (5 pts)
...
g. Compare your stream health data from Young's Gulch with the stream health from the Cameron Peak fire. We're there differences between the biotic index and qualitative assesements between the two streams? (5 pts)
